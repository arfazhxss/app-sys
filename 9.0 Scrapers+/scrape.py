...
jobs = scrape_jobs(
    ...
    search_term="software engineer \"intern\" co-op OR software developer intern co-op",
    location="Canada",
    verbose=2,
    results_wanted=500,
    job_type="internship",
    country_indeed='Canada',  # only needed for indeed / glassdoor
    # hours_old=15, # (only Linkedin/Indeed is hour specific, others round up to days old)
