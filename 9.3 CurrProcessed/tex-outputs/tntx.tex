...
% Define variables
\newcommand{\Position}{Summer Engineering and Development}
\newcommand{\CompanyName}{MKS Instruments}
\newcommand{\CompanyNameSuffix}{Inc.}
\newcommand{\Division}{OSP Division}
\newcommand{\LocationCity}{Richmond}
