...
% Define variables
\newcommand{\Position}{Junior Application Support Analyst}
\newcommand{\CompanyName}{Microserve}
\newcommand{\CompanyNameSuffix}{Business Computer Services}
\newcommand{\Division}{Victoria Office}
