...
% Define variables
\newcommand{\Position}{Acoustical Engineering Intern}
\newcommand{\CompanyName}{BKL Consultants}
\newcommand{\CompanyNameSuffix}{Ltd.}
\newcommand{\Division}{BKL Consultants}
\newcommand{\LocationCity}{Burnaby, Greater Vancouver}
