...
% Define variables
\newcommand{\Position}{Software Engineer I in Cloud}
\newcommand{\CompanyName}{Planview}
\newcommand{\CompanyNameSuffix}{}
\newcommand{\Division}{Flow Platform}
