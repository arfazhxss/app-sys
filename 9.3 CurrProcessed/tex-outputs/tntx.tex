...
% Define variables
\newcommand{\Position}{Agile Software Engineer}
\newcommand{\CompanyName}{TribalScale}
\newcommand{\CompanyNameSuffix}{}
\newcommand{\Division}{TribalScale Canada HQ}
...
\begin{itemize} 
	\item \textbf{Agile Software Development}: I have extensive experience developing mobile and web applications using Swift, TypeScript, React and Node.js. I've collaborated in team environments, adopting Agile methodologies such as pair programming and continuous integration to deliver quality software.

	\item \textbf{Project Ownership and Innovation}: I have led over 13 software projects, including mobile and web apps, where I contributed to product design, development, and deployment. 

	\item \textbf{AI and Testing Automation}: I have applied automation tools like Selenium and Puppeteer and leveraged Large Language Models (LLMs) to automate testing and optimize the development lifecycle. My background includes building scalable, AI-powered systems that improve efficiency and quality across projects.

	\item \textbf{Collaboration and Client Engagement}: I've worked with diverse teams, mentoring peers at VikeLabs and collaborating in client-facing projects. My strong communication skills have enabled me to work closely with stakeholders to ensure project alignment and deliver exceptional results. 
\end{itemize}
