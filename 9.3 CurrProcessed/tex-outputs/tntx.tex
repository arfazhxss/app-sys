...
% Define variables
\newcommand{\Position}{IT Student Researcher Co-op role}
\newcommand{\CompanyName}{Xenon Pharmaceuticals}
\newcommand{\CompanyNameSuffix}{Inc.}
\newcommand{\Division}{Research \& Lab Information Systems}
...
% Letter details
\textbf{Ashlin Richardson}\\
\textit {Band 3 Senior Data Scientist and Manager of Business Intelligence}\\
\text{\CompanyName}\text{, \Division} \\
\vspace{20pt}\text{\LocationCity}, \text{\LocationState} \\
\vspace{10pt}\text{Dear Mr. Richardson:} \\
