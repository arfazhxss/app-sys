...
% Define variables
\newcommand{\Position}{DevOps}
\newcommand{\CompanyName}{D-Wave Systems}
...
\begin{itemize}
    ...
    \item \textbf{Cross-Platform App Development}: I have built mobile applications using React Native, which enabled cross-platform compatibility for both Android and iOS devices.
