...
% Define variables
\newcommand{\Position}{Professional Services Explorer}
\newcommand{\CompanyName}{CrowdStrike}
\newcommand{\CompanyNameSuffix}{Inc.}
\newcommand{\Division}{Professional Services}
\newcommand{\LocationCity}{Remote}
\newcommand{\LocationState}{Canada}
\newcommand{\Terms}{a 12-month}
...
\begin{itemize}
    ...
    \item \textbf{Continuous Integration and Continuous Deployment}: I have integrated automated testing into CI/CD pipelines using tools like Jenkins and GitHub Actions. 
\end{itemize}
